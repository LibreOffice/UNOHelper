...
public class UNO
{
  ...
  public static Object executeGlobalMacro(String macroName, Object[] args)
  {
    ...
    return Internal.executeMacroInternal(macroName, args, null,
      ...
      boolean caseSensitive, String[] location)
  {
    ...
    List<Internal.FindNode> found = new LinkedList<Internal.FindNode>();
    ...
    Internal.findBrowseNodeTreeLeavesAndScriptProviders(
    ...
    Internal.FindNode findNode = found.get(0);
  ...
  private static class Internal
  {
    ...
    public static int findBrowseNodeTreeLeavesAndScriptProviders(
        ...
        XScriptProvider xScriptProvider, List<FindNode> found)
    {
      ...
      if (!iter.hasNext())
      {
        ...
        FindNode findNode = new FindNode(node.unwrap(), xScriptProvider,
            nodeLocation, isCaseCorrect);
        ListIterator<FindNode> liter = found.listIterator();
        while (liter.hasNext())
        {
     ...
     * @author bnk
     */
    private static Object executeMacroInternal(String macroName, Object[] args,
